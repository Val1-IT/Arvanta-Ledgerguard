import { ACCOUNT } from '../domain/constants';
...
export function summarizeJournalCogs(entries: JournalEntryRecord[], cogsAccountCode: string = ACCOUNT.COGS): JournalCogsSummary {
  let postedCogs = ZERO;
